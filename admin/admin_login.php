...
<head>
    ...
    <title>Iniciar sesion en el panel de Administrador</title>
...
<body>
    ...
    <div class="landing admin-register">
        <div class="">
            <h2 class="text-center mb-1">Iniciar sesion Administrador</h2>
            <h4 class="text-center mb-3 fw-light">Inicia Sesion en tu Cuenta</h4>
                    ...
                    <div>
                        <form action="" method="post" class="d-flex flex-column gap-4">
                            ...
                            <div class="form-outline">
                                ...
                                <p class="small">
                                ¿No tienes una cuenta? <a href="./admin_resgistration.php" class="text-decoration-underline text-success fw-bold">Registrate</a>
                                </p>
                            </div>
                        </form>
                    </div>
