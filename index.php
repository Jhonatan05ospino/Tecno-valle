...
<body>
            ...
            <div class="row m-0">
                <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12 p-md-0 tabs-categ">
                    <ul class="p-md-0 d-flex flex-column gap-3 pt-md-3">
                        ...
                        <li>Portatiles</li>
                        <li>Drones</li>
                        <li>Consolas de Videojuego</li>
                        <li>Scooters Electricas</li>
                        <li>Camaras</li>
                ...
                <div class="col-lg-9 col-md-9 d-none d-sm-none d-md-block pt-md-4">
                    <div class="cover">
                        ...
                        <span class="desc">Hasta un 10%<br />Cupón de descuento</span>
    ...
    <div class="adver">
        <div class="container">
            <div class="cover">
                <span class="title">Categorias</span>
                <span class="desc">Mejora tu<br />Experiencia Musical</span>
    ...
    <div class="products">
        <div class="container">
            <div class="categ-header">
                ...
                <h2>Explorara nuestros Productos</h2>
            </div>
            <div class="row mb-3">
                <?php
                getProduct(3);
