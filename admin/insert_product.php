...
if(isset($_POST['insert_product'])){
    ...
    if($product_title == '' || $product_description == '' || $product_keywords == '' || $product_category == '' || $product_brand == '' || empty($product_price) || empty($product_image_one) || empty($product_image_two) || empty($product_image_three)){
        echo "<script>alert(\"Los campos no deben estar vacíos\");</script>";
        exit();
    }else{
        //move folders
            ...
            <div class="row justify-content-center">
                <div class="col-md-5">
                    ...
                    <div class="form-outline mb-4">
                        <label for="product_title" class="form-label">Titulo de Producto</label>
                        <input type="text" placeholder="Digita el Titulo de Producto" name="product_title" id="product_title" class="form-control" autocomplete="off" required>
                    </div>
                    <!-- description -->
                    <div class="form-outline mb-4">
                        <label for="product_description" class="form-label">Descripcion del Producto</label>
                        <input type="text" placeholder="Digita la Descripcion del Producto" name="product_description" id="product_description" class="form-control" autocomplete="off" required>
                    </div>
                    <!-- keywords -->
                    <div class="form-outline mb-4">
                        <label for="product_keywords" class="form-label">Palabra Clave del Producto</label>
                        <input type="text" placeholder="Digita Palabra Clave del  Producto " name="product_keywords" id="product_keywords" class="form-control" autocomplete="off" required>
                    </div>
                    <!-- categories -->
                    <div class="form-outline mb-4">
                        <select class="form-select" name="product_category" id="product_category">
                            <option selected disabled>Selecciona una Cateogria</option>
                            <?php
                    ...
                    <!-- Image one -->
                    <div class="form-outline mb-4">
                        <label for="product_image_one" class="form-label">Imagen Del Producto Uno</label>
                        <input type="file" name="product_image_one" id="product_image_one" class="form-control" required>
                    </div>
                    <!-- Image two -->
                    <div class="form-outline mb-4">
                        <label for="product_image_two" class="form-label">Imagen Del Producto Dos</label>
                        <input type="file" name="product_image_two" id="product_image_two" class="form-control" required>
                    </div>
                    <!-- Image three -->
                    <div class="form-outline mb-4">
                        <label for="product_image_three" class="form-label">Imagen Del Producto Tres</label>
