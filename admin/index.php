...
<body>
    ...
    <div class="upper-nav primary-bg p-2 px-3 text-center text-break">
        <span>Panel de administración y entrega expres gratuita</span>
    </div>
    <!-- upper-nav -->
    <!-- Start NavBar -->
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContentad">
                <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                    ...
                    <button class="btn btn-primary p-0 px-1">
                            <a href="./admin_logout.php" class="nav-link text-light">Cerrar Session</a>
                        </button>
                    </li>
                </ul>
        ...
        <div class="container pt-4 pb-0">
            <div class="categ-header">
                <div class="sub-title">
                    ...
                    <span class="title">Dashboarddel Administrador</span>
                </div>
            ...
            <div class="row align-items-center">
                ...
                <div class="col-md-10">
                    <div class="buttons">
                        ...
                        <button class="btn btn-outline-primary m-2">
                            <a href="index.php?insert_category" class="nav-link">Insertar Categorias</a>
                        </button>
                        <button class="btn btn-outline-primary m-2">
                            <a href="index.php?view_categories" class="nav-link">Ver Categorias</a>
                        </button>
                        <button class="btn btn-outline-primary m-2">
                            <a href="index.php?insert_brand" class="nav-link">Insertar Ramas</a>
                        </button>
                        <button class="btn btn-outline-primary m-2">
                            <a href="index.php?view_brands" class="nav-link">Ver Ramas</a>
                        </button>
                        <button class="btn btn-outline-primary m-2">
                            <a href="index.php?list_orders" class="nav-link">Todas las Ordenes</a>
                        </button>
                        <button class="btn btn-outline-primary m-2">
                            <a href="index.php?list_payments" class="nav-link">Todos los Pagos</a>
                        </button>
                        <button class="btn btn-outline-primary m-2">
                            <a href="index.php?list_users" class="nav-link">Lista de  Usuarios</a>
                        </button>
                    </div>
                </div>
            </div>
