    ...
    if(isset($_POST['insert_brand_title'])){
        ...
        if($numOfResults>0){
            echo "<script>alert('This Brand is already in DataBase');</script>";
                ...
                if ($insert_result){
                    echo "<script>alert('Esta marca ya está en la base de datos');</script>";
                }
...
<form action="" method="POST" class="mb-2">
    ...
    <div class="input-group w-10 mb-3">
        <input type="submit" class="btn btn-primary" name="insert_brand_title" value="Insertar Marcas" aria-label="Brands" aria-describedby="basic-addon1">
    </div>
</form>